      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white/70 dark:bg-white/[0.04] p-7 shadow-2xl backdrop-blur-xl">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div
                className={`flex items-center gap-2.5 rounded-xl border bg-white dark:bg-white/[0.03] px-3.5 py-2.5 transition-colors ${
                  focused === 'email'
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-slate-500 dark:text-[#9295B8]">
            ...
            <Link href="/register" className="font-medium text-[#2B4C7E] dark:text-[#7FB4E8] hover:text-slate-900 dark:hover:text-white transition-colors">
              Create one
            </Link>
          </p>
        </div>
